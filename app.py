"""
app.py â€” MODE Pipeline Â· Emanuel Duarte Â· 2026
Îµ dinÃ¡mico Â· Ï„ semidinamico Â· RÂ³ descriptor de co-estabilizaciÃ³n
RevisiÃ³n v2.1: Valores HONESTOS Â· Streamlit 1.57 compatible Â· Arrow safe
"""
...
VERSION = "v2.1 Â· Pergamino, Argentina Â· 2026"
...
# â”€â”€ UTILIDAD: formateo seguro de floats â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
def fmt(v, decimals=8):
    """Formatea un valor numÃ©rico de forma segura, incluyendo NaN."""
    if v is None:
        return 'N/A'
    try:
        f = float(v)
...
# â”€â”€ SEÃ‘ALES DEMO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
DEMOS = {
    'Lorenz (caÃ³tico clÃ¡sico)':           lorenz_ts,
    'RÃ¶ssler (caos dÃ©bil)':               rossler_ts,
    'Mapa LogÃ­stico r=3.9 (caÃ³tico)':    lambda n=1000:_logistic_map(n,r=3.9),
    'Mapa LogÃ­stico r=3.5 (periÃ³dico)':  lambda n=1000:_logistic_map(n,r=3.5),
    'Mapa LogÃ­stico r=3.7 (transiciÃ³n)': lambda n=1000:_logistic_map(n,r=3.7),
...
# â”€â”€ UTILIDADES VISUALES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
def watermark(fig):
...
# â”€â”€ FIGURAS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def fig_metrics(result):
    ...
    ax.set_xlabel('|dmu/dtau| / RMS(mu) â€” gradiente normalizado',fontsize=7)
...
# â”€â”€ LECTOR MIT-BIH â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
def main():
    st.set_page_config(page_title="MODE Â· Attractor Pipeline",page_icon="ðŸŒ€",
    ...
    with st.sidebar:
        ...
        # Inicializar con array vacÃ­o (no dict)
        x_data = np.array([])
        label  = 'sin datos'
        extra  = {}
    ...
    # â”€â”€ EJECUCION â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    if run_btn:
        if len(x_data) == 0:
    ...
    # â”€â”€ PANTALLA INICIAL â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    if 'mode' not in st.session_state:
        st.markdown(
            f"<div style='text-align:center;padding:60px 20px;'>"
            f"<div style='font-size:3.5rem;margin-bottom:16px;'>ðŸŒ€</div>"
            ...
            f"<b>Revision 2026-05:</b> Calculos HONESTOS Â· Gradientes RMS Â· R3 continuo Â· Arrow-safe<br>"
    ...
    # â”€â”€ MODO VENTANAS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ MODOS NORMALES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    with tab5:
        st.subheader("Tabla completa â€” valores sin truncado ni redondeo")

        # FIX Arrow: todas las columnas como str explÃ­citamente
        rows=[
