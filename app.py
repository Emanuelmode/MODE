...
def add_watermark(fig):
    """Agrega marca de agua diagonal a la figura."""
    fig.text(
        0.5, 0.5, WATERMARK,
        fontsize=11, color='white', alpha=0.10,
        ha='center', va='center',
        rotation=30, fontfamily='monospace',
    ...
    fig.text(
        0.99, 0.01, WATERMARK,
        fontsize=7, color='white', alpha=0.30,
        ha='right', va='bottom',
...
def main():
    ...
    st.caption("Investigador: Emanuel Duarte &nbsp;·&nbsp; Pergamino, Argentina · 2026")
    st.divider()
